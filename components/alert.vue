...
transition(name="alert")
    div.w-full.group.p-4.flex.items-center.gap-3.rounded-lg.relative(:class="{ 'bg-green-600': type == 'success', 'bg-yellow-500': type == 'warning', 'bg-red-500': type == 'danger', 'bg-blue-500': type == 'info' }" v-if="data.isActive")
